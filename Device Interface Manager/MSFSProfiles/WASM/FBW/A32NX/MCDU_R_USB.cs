    ...
    public class MCDU_R_USB : USBWASM
    {
        ...
        private bool MCDU_R_ANNUNC_FAIL
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 2, this._mCDU_R_ANNUNC_FAIL = value);
                }
            }
        }
        ...
        private bool MCDU_R_ANNUNC_FMGC
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 3, this._mCDU_R_ANNUNC_FMGC = value);
                }
            }
        }
        ...
        private bool MCDU_R_ANNUNC_FM
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 4, this._mCDU_R_ANNUNC_FM = value);
                }
            }
        }
        ...
        private bool MCDU_R_ANNUNC_MCDU_MENU
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 5, this._mCDU_R_ANNUNC_MCDU_MENU = value);
                }
            }
        }
        ...
        private bool MCDU_R_ANNUNC_FM1
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 9, this._mCDU_R_ANNUNC_FM1 = value);
                }
            }
        }
        ...
        private bool MCDU_R_ANNUNC_IND
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 10, this._mCDU_R_ANNUNC_IND = value);
                }
            }
        }
        ...
        private bool MCDU_R_ANNUNC_RDY
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 11, this._mCDU_R_ANNUNC_RDY = value);
                }
            }
        }
        ...
        private bool MCDU_R_ANNUNC_FM2
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 13, this._mCDU_R_ANNUNC_FM2 = value);
                }
            }
        }
        ...
        private bool MCDU_R_LIGHTTEST
        {
            set
            {
                ...
                {
                    _ = interfaceIT_LED_Set(this.Device.Session, 2, this._mCDU_R_LIGHTTEST = value);
                    _ = interfaceIT_LED_Set(this.Device.Session, 3, this._mCDU_R_LIGHTTEST);
                    _ = interfaceIT_LED_Set(this.Device.Session, 4, this._mCDU_R_LIGHTTEST);
                    _ = interfaceIT_LED_Set(this.Device.Session, 5, this._mCDU_R_LIGHTTEST);
                    _ = interfaceIT_LED_Set(this.Device.Session, 9, this._mCDU_R_LIGHTTEST);
                    _ = interfaceIT_LED_Set(this.Device.Session, 10, this._mCDU_R_LIGHTTEST);
                    _ = interfaceIT_LED_Set(this.Device.Session, 11, this._mCDU_R_LIGHTTEST);
                    _ = interfaceIT_LED_Set(this.Device.Session, 13, this._mCDU_R_LIGHTTEST);
                }
            }
        }
        ...
        protected override bool KeyPressedProc(int session, int key, int direction)
        {
            ...
            switch (key)
            {
                ...
                case 3:
                    this.MobiFlightSimConnect.SetEventID("A320_Neo_CDU_2_BTN_SEC");
                    break;
                ...
                case 55:
                    this.MobiFlightSimConnect.SetEventID("A320_Neo_CDU_2_BTN_0");
                    break;
