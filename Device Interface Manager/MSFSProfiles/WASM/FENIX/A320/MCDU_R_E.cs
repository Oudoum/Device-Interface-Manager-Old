    ...
    public class MCDU_R_E : ENETWASM
    {
        ...
        private bool CDU2_FAIL
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(2, this._cDU2_FAIL = value);
                }
            }
        }
        ...
        private bool CDU2_MCDU_MENU
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(3, this._cDU2_MCDU_MENU = value);
        ...
        private bool CDU2_FM
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(4, this._cDU2_FM = value);
                }
            }
        }
        ...
        private bool CDU2_FM1
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(6, this._cDU2_FM1 = value);
                }
            }
        }
        ...
        private bool CDU2_IND
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(7, this._cDU2_IND = value);
                }
            }
        }
        ...
        private bool CDU2_RDY
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(8, this._cDU2_RDY = value);
                }
            }
        }
        ...
        private bool CDU2_DASH
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(9, this._cDU2_DASH = value);
                }
            }
        }
        ...
        private bool CDU2_FM2
        {
            set
            {
                ...
                {
                    this.InterfaceITEthernet.SendinterfaceITEthernetLED(10, this._cDU2_FM2 = value);
                }
            }
        }
