...
public class NG_CDU_R_USB : NG_CDU_Base_USB
{
    public NG_CDU_R_USB()
    {
        startupManager.Settings = @"Profiles\PMDG 737\USB CDU Screen R.json";
    ...
    protected override void RecvData()
    {
        ...
        CDU_annunCALL = pMDG_NG3_Data.CDU_annunCALL[1];
        CDU_annunMSG = pMDG_NG3_Data.CDU_annunMSG[1];
        CDU_annunFAIL = pMDG_NG3_Data.CDU_annunFAIL[1];
        CDU_annunOFST = pMDG_NG3_Data.CDU_annunOFST[1];
    }
