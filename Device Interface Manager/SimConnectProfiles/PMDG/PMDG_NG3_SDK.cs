...
{
    public const string DATA_NAME = "PMDG_NG3_Data";
    public const string CONTROL_NAME = "PMDG_NG3_Control";
    public const string CDU_0_NAME = "PMDG_NG3_CDU_0";
    public const string CDU_1_NAME = "PMDG_NG3_CDU_1";
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 4)]
    public readonly struct PMDG_NG3_CDU_Screen : PMDG_CDU_SDK.ICDU_Screen
    {
