...
public class B747_CDU_C : CDU_Base_E<PMDG_747QOTSII_Data>
{
    protected override string SettingsLocation => @"Profiles\PMDG 747\ENET CDU Screen C.json";
    ...
    protected override void KeyPressedAction(int key, uint direction)
    {
        ...
        switch (key)
        {
            ...
            case 61:
                simConnectClient.TransmitEvent(direction, PMDGEvents.EVT_CDU_C_ATC);
                break;
