...
namespace Device_Interface_Manager.SimConnectProfiles.PMDG.B747.E;

public class B747_CDU_R : CDU_Base_E<PMDG_747QOTSII_Data>
{
    protected override string SettingsLocation => @"Profiles\PMDG 747\ENET CDU Screen R.json";
    ...
    protected override void RecvData()
    {
        ...
        CDU_annunCALL = PMDG_Data.CDU_annunDSPY[1];
    ...
    protected override void KeyPressedAction(int key, uint direction)
    {
        ...
        switch (key)
        {
            ...
            case 42:
                simConnectClient.TransmitEvent(direction, PMDGEvents.EVT_CDU_R_NAV_RAD);
                break;
            ...
            case 53:
                simConnectClient.TransmitEvent(direction, PMDGEvents.EVT_CDU_R_FMCCOMM);
                break;
            ...
            case 61:
                simConnectClient.TransmitEvent(direction, PMDGEvents.EVT_CDU_R_ATC);
                break;

            case 62:
                simConnectClient.TransmitEvent(direction, PMDGEvents.EVT_CDU_R_VNAV);
                break;
