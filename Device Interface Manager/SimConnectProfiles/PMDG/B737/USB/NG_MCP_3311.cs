...
public class NG_MCP_3311 : SimConnectProfiles.USB
{
    ...
    protected override void SimConnect_OnRecvClientData(uint dwRequestID, object dwData)
    {
        ...
        {
            SetELEC_BusPowered(((PMDG_NG3_Data)dwData).ELEC_BusPowered);

            MCP_ATArmSw = ((PMDG_NG3_Data)dwData).MCP_ATArmSw;

            MCP_annunFD_0 = ((PMDG_NG3_Data)dwData).MCP_annunFD[0];
            MCP_annunFD_1 = ((PMDG_NG3_Data)dwData).MCP_annunFD[1];
            MCP_annunATArm = ((PMDG_NG3_Data)dwData).MCP_annunATArm;
            MCP_annunN1 = ((PMDG_NG3_Data)dwData).MCP_annunN1;
            MCP_annunSPEED = ((PMDG_NG3_Data)dwData).MCP_annunSPEED;
            MCP_annunVNAV = ((PMDG_NG3_Data)dwData).MCP_annunVNAV;
            MCP_annunLVL_CHG = ((PMDG_NG3_Data)dwData).MCP_annunLVL_CHG;
            MCP_annunHDG_SEL = ((PMDG_NG3_Data)dwData).MCP_annunHDG_SEL;
            MCP_annunLNAV = ((PMDG_NG3_Data)dwData).MCP_annunLNAV;
            MCP_annunVOR_LOC = ((PMDG_NG3_Data)dwData).MCP_annunVOR_LOC;
            MCP_annunAPP = ((PMDG_NG3_Data)dwData).MCP_annunAPP;
            MCP_annunALT_HOLD = ((PMDG_NG3_Data)dwData).MCP_annunALT_HOLD;
            MCP_annunVS = ((PMDG_NG3_Data)dwData).MCP_annunVS;
            MCP_annunCMD_A = ((PMDG_NG3_Data)dwData).MCP_annunCMD_A;
            MCP_annunCWS_A = ((PMDG_NG3_Data)dwData).MCP_annunCWS_A;
            MCP_annunCMD_B = ((PMDG_NG3_Data)dwData).MCP_annunCMD_B;
            MCP_annunCWS_B = ((PMDG_NG3_Data)dwData).MCP_annunCWS_B;

            LTS_MainPanelKnob_0 = ((PMDG_NG3_Data)dwData).LTS_MainPanelKnob[0];

            MCP_indication_powered = ((PMDG_NG3_Data)dwData).MCP_indication_powered;
            MCP_IASBlank = ((PMDG_NG3_Data)dwData).MCP_IASBlank;
            MCP_IASOverspeedFlash = ((PMDG_NG3_Data)dwData).MCP_IASOverspeedFlash;
            MCP_IASUnderspeedFlash = ((PMDG_NG3_Data)dwData).MCP_IASUnderspeedFlash;
            MCP_VertSpeedBlank = ((PMDG_NG3_Data)dwData).MCP_VertSpeedBlank;

            if (MCP_indication_powered)
            {
                MAIN_LightsSelector = ((PMDG_NG3_Data)dwData).MAIN_LightsSelector;
                MCP_IASMach = ((PMDG_NG3_Data)dwData).MCP_IASMach;
                MCP_Course_0 = ((PMDG_NG3_Data)dwData).MCP_Course[0];
                MCP_Course_1 = ((PMDG_NG3_Data)dwData).MCP_Course[1];
                MCP_VertSpeed = ((PMDG_NG3_Data)dwData).MCP_VertSpeed;
                SetHeadingAltitude(((PMDG_NG3_Data)dwData).MCP_Heading, ((PMDG_NG3_Data)dwData).MCP_Altitude);
            }
        }
    }
