...
public class B777_CDU_R : CDU_Base_E<PMDG_777X_Data>
{
    protected override string SettingsLocation => @"Profiles\PMDG 777\ENET CDU Screen R.json";
    ...
    protected override void KeyPressedAction(int key, uint direction)
    {
        ...
        switch (key)
        {
            ...
            case 61:
                simConnectClient.TransmitEvent(direction, PMDGEvents.EVT_CDU_R_ALTN);
                break;
