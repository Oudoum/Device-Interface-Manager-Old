...
{
    public static ushort GetProduct(ushort hexCode) => (ushort)((hexCode & 0xFF00) >> 8);

    public static ushort GetModel(ushort hexCode) => (ushort)((hexCode & 0xFF) >> 0);
}

public enum InterfaceIT_BoardIDs : ushort
{
