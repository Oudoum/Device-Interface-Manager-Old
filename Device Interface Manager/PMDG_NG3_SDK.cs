...
namespace PMDG_SDK
{
    ...
    {
        // Notification Group priority values (SimConnect API)
        //
        public enum SIMCONNECT_GROUP_PRIORITY : uint
        {
            HIGHEST             =   1u,                 // highest priority
            HIGHEST_MASKABLE    =   10000000u,          // highest priority that allows events to be masked
            STANDARD            =   1900000000u,        // standard priority
            DEFAULT             =   2000000000u,        // default priority
            LOWEST              =   4000000000u,        // priorities lower than this will be ignored 
        };
        ...
        public enum PMDG_NG3
        {
            ...
            CDU_0_ID            =    0x4E473335,
            CDU_1_ID            =    0x4E473336,
            CDU_0_DEFINITION    =    0x4E473338,
            CDU_1_DEFINITION    =    0x4E473339,
        };
        ...
        {
            public byte Symbol;
            public byte Color;                                        // any of PMDG_NG3_CDU_COLOR_ defines
            public byte Flags;                                        // a combination of PMDG_NG3_CDU_FLAG_ bits
        };
        ...
        public struct PMDG_NG3_CDU_Screen
        {
            ...
            public struct CDUROWS
            {
                ...
                public PMDG_NG3_CDU_Cell[] CDU_ROWS;
            }
        ...
        public const int PMDG_NG3_CDU_COLOR_WHITE     = 0;
        public const int PMDG_NG3_CDU_COLOR_CYAN      = 1;
        public const int PMDG_NG3_CDU_COLOR_GREEN     = 2;
        public const int PMDG_NG3_CDU_COLOR_MAGENTA   = 3;
        public const int PMDG_NG3_CDU_COLOR_AMBER     = 4;
        public const int PMDG_NG3_CDU_COLOR_RED       = 5;

        // NG3 CDU Screen Cell flags
        public const int PMDG_NG3_CDU_FLAG_SMALL_FONT = 0x01;      // small font, including that used for line headers 
        public const int PMDG_NG3_CDU_FLAG_REVERSE    = 0x02;      // character background is highlighted in reverse video
        public const int PMDG_NG3_CDU_FLAG_UNUSED     = 0x04;      // dimmed character color indicating inop/unused entries
        ...
        public const int ACP_SEL_RECV_VHF1   =   0x0001;
        public const int ACP_SEL_RECV_VHF2   =   0x0002;
        public const int ACP_SEL_RECV_VHF3   =   0x0004;
        public const int ACP_SEL_RECV_HF1    =   0x0008;
        public const int ACP_SEL_RECV_HF2    =   0x0010;
        public const int ACP_SEL_RECV_FLT    =   0x0020;
        public const int ACP_SEL_RECV_SVC    =   0x0040;
        public const int ACP_SEL_RECV_PA     =   0x0080;
        public const int ACP_SEL_RECV_NAV1   =   0x0100;
        public const int ACP_SEL_RECV_NAV2   =   0x0200;
        public const int ACP_SEL_RECV_ADF1   =   0x0400;
        public const int ACP_SEL_RECV_ADF2   =   0x0800;
        public const int ACP_SEL_RECV_MKR    =   0x1000;
        public const int ACP_SEL_RECV_SPKR   =   0x2000; 
